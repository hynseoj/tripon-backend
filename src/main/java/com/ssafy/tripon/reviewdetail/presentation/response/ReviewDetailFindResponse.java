...
public record ReviewDetailFindResponse(
        Integer id,
        Integer reviewId,
        Integer day,
        String content,
    ...
    public static ReviewDetailFindResponse from(ReviewDetailServiceResponse response) {
        return new ReviewDetailFindResponse(
                response.id(),
                response.reviewId(),
                response.day(),
                response.content(),
